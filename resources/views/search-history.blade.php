        ...
        <tr>
            ...
            <td>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li>
                        <a href="/search-history/delete/{{$word->id}}" class="dropdown-item" data-confirm-delete="true"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
